...
import { ArrowLeft, Palette, Settings2, ShieldCheck, Save, Trash2, Github, ChevronRight } from 'lucide-react';
...
export default function SettingsPage() {
  ...
  const handleSave = () => {
    localStorage.setItem('streamplay-theme-color', themeColor.replace('#', ''));
    setIsSaved(true);
  ...
  const handleReset = () => {
    ...
    localStorage.setItem('streamplay-theme-color', defaultColor);
        ...
        <section className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="bg-zinc-900/40 border border-white/5 rounded-3xl p-6 lg:p-8 backdrop-blur-md space-y-8">
            ...
            <div className="space-y-4">
              <label className="text-sm font-bold text-zinc-400 uppercase tracking-widest px-1">Cor Principal do Tema</label>
              <div className="flex items-center gap-4 bg-black/20 p-4 rounded-2xl border border-white/5">
                ...
                <div className="flex-1 space-y-1">
                  ...
                  />
                  <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider">Toque no quadrado para escolher visualmente</p>
                </div>
              </div>
            </div>
        ...
        <section className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="bg-zinc-900/40 border border-white/5 rounded-3xl p-6 space-y-4">
            <div className="flex justify-between items-center text-sm font-medium py-2 border-b border-white/5">
              ...
              <span className="text-zinc-300">v2.5.0-premium</span>
            </div>
            <div className="flex justify-between items-center text-sm font-medium py-2 border-b border-white/5">
